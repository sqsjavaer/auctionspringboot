...
public class User {
	...
	public String getUser_answe() {
		return user_answe;
	}
	public void setUser_answe(String user_answe) {
		this.user_answe = user_answe;
	}
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_name=" + user_name
				...
				+ user_question + ", user_answe=" + user_answe + "]";
	}  
